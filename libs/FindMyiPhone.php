...
class FindMyiPhone
{
    ...
    public function refresh_client()
    {
        ...
        if (property_exists($get_data, 'userInfo') && property_exists($get_data, 'content')) {
            ...
            $this->devices = 'wrong credentials';
        }
    }
    ...
    public function play_sound($device_id, $subject = 'Find My iPhone Alert')
    {
        if (!is_string($device_id)) {
            throw new FindMyiPhoneException('Expected $device_id to be a string');
        }
        if (!is_string($subject)) {
            throw new FindMyiPhoneException('Expected $subject to be a string');
        }
    ...
    public function send_message($device_id, $text, $sound = false, $subject = 'Important Message')
    {
        ...
        if (!is_string($text)) {
            throw new FindMyiPhoneException('Expected $text to be a string');
        }
        if (!is_bool($sound)) {
            throw new FindMyiPhoneException('Expected $sound to be a bool');
        }
        if (!is_string($subject)) {
            throw new FindMyiPhoneException('Expected $subject to be a string');
        }
    ...
    public function lost_device($device_id, $passcode, $owner_phone_number = '911', $sound = true, $text = 'This iPhone has been lost. Please call me.')
    {
        ...
        if (!is_string($passcode)) {
            throw new FindMyiPhoneException('Expected $passcode to be a string');
        }
        if (strlen($passcode) !== 4) {
            throw new FindMyiPhoneException('Expected $passcode to be 4 characters long');
        }
        if (!is_string($owner_phone_number)) {
            throw new FindMyiPhoneException('Expected $owner_phone_number to be a string');
        }
        if (!is_bool($sound)) {
            throw new FindMyiPhoneException('Expected $sound to be a bool');
        }
    ...
    public function notify_when_found($device_id, $notify = true)
    {
        ...
        if (!is_bool($notify)) {
            throw new FindMyiPhoneException('Expected $notify to be a boolean');
        }
    ...
    public function lock_and_message($device_id, $passcode, $text, $sound = true, $title = 'Find My iPhone Alert')
    {
        ...
        if (!is_string($title)) {
            throw new FindMyiPhoneException('Expected $title to be a string');
        }
    ...
    public function locate_device($device, $timeout = 120)
    {
        if (!is_integer($device)) {
            throw new FindMyiPhoneException('Expected $device to be an integer');
        }
    ...
    {
        if (!is_string($method)) {
            throw new FindMyiPhoneException('Expected $method to be a string');
        }
        if (!$this->is_json($post_data)) {
            throw new FindMyiPhoneException('Expected $post_data to be json');
        }
        if (!is_array($headers)) {
            throw new FindMyiPhoneException('Expected $headers to be an array');
        }
        if (!is_bool($return_headers)) {
            throw new FindMyiPhoneException('Expected $return_headers to be a bool');
        }
        if (!isset($this->scope)) {
